...
export class CategoriesFilterComponent implements OnInit, OnDestroy, OnChanges {
  ...
  classListFirst = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-offerings-muted-text border border-b-0 border-offerings-border rounded-t-xl focus:ring-4 focus:ring-secondary-50 dark:focus:ring-secondary-200 dark:border-secondary-200 dark:text-offerings-on-dark-body hover:bg-offerings-neutral dark:hover:bg-tertiary-100 gap-3';
  classListLast  = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-offerings-muted-text border border-offerings-border focus:ring-4 focus:ring-secondary-50 dark:focus:ring-secondary-200 dark:border-secondary-200 dark:text-offerings-on-dark-body hover:bg-offerings-neutral dark:hover:bg-tertiary-100 gap-3';
  classList      = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-offerings-muted-text border border-b-0 border-offerings-border focus:ring-4 focus:ring-secondary-50 dark:focus:ring-secondary-200 dark:border-secondary-200 dark:text-offerings-on-dark-body hover:bg-offerings-neutral dark:hover:bg-tertiary-100 gap-3';
  
  classListFirstChecked = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-offerings-muted-text border border-2 border-primary-50 rounded-t-xl focus:ring-4 focus:ring-secondary-50 dark:focus:ring-secondary-200 dark:border-primary-50 dark:text-offerings-on-dark-body hover:bg-offerings-neutral dark:hover:bg-secondary-300 gap-3';
  classListLastChecked  = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-offerings-muted-text border border-2 border-primary-50 focus:ring-4 focus:ring-secondary-50 dark:focus:ring-secondary-200 dark:border-primary-50 dark:text-offerings-on-dark-body hover:bg-offerings-neutral dark:hover:bg-secondary-300 gap-3';
  classListChecked      = 'flex items-center justify-between w-full p-5 font-medium rtl:text-right text-offerings-muted-text border border-2 border-primary-50 focus:ring-4 focus:ring-secondary-50 dark:focus:ring-secondary-200 dark:border-primary-50 dark:text-offerings-on-dark-body hover:bg-offerings-neutral dark:hover:bg-secondary-300 gap-3';
    
  labelClass: string = "text-offerings-muted-text bg-offerings-surface border-2 rounded-lg cursor-pointer dark:hover:text-offerings-on-dark-body dark:border-secondary-200 peer-checked:border-primary-50 hover:text-offerings-body dark:peer-checked:bg-primary-50 dark:peer-checked:text-secondary-100 peer-checked:text-offerings-body hover:bg-offerings-page dark:text-offerings-on-dark-body dark:bg-tertiary-100 dark:hover:bg-primary-50";
  categories: Category[] = [];
